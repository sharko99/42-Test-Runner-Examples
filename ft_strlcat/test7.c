...
int main(void)
{
	...
	size_t siz_kern_2 = 56; // world + nul
	char dest1[100];
	strlcpy(dest1, "hello", siz_kern);
	char source1[100];
	strlcpy(source1, "woooooooooooooooooooooooooooooooooooooooooooooooooooooo", siz_kern_2);
	char dest2[100];
	strlcpy(dest2, "hello", siz_kern);
	char source2[100];
	strlcpy(source2, "woooooooooooooooooooooooooooooooooooooooooooooooooooooo", siz_kern_2);
	size_t siz = -15;
